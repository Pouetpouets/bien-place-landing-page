      ...
      <div className="mx-auto max-w-2xl py-30 sm:py-48 lg:py-56">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Une extension Chrome pour vous aider à localiser vos recherches immobiliéres, connaitre la consomation energétique, la qualité des isolations et plus encore.
          </p>
